 ...
 */
public class MoraCalculateCRC
{
    final static Logger LOGGER = LogManager.getLogger(MoraCalculateCRC.class);

    public String getCRC16_CCITT_False_X16_X12_X5_1_Poly_1021(String payload){
        int checksum = 0xffff;
        ...
        System.out.println("CRC : "+String.format("%04X", checksum));
