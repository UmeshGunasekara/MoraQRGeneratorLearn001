DROP DATABASE IF EXISTS sample_db_v002;
CREATE DATABASE sample_db_v002;
USE sample_db_v002;
...
(
  ...
  item_qty_on_hand Int NOT NULL DEFAULT 0,
  item_measure_unit Char(5),
  item_unit_price Decimal(15,2) DEFAULT 0,
  raw_last_update_date_time Datetime NOT NULL,
  raw_last_update_log_id Int NOT NULL,
  update_user_account_id Int NOT NULL,
  raw_show_status Int NOT NULL,
...
DROP TABLE IF EXISTS SB_ITEM_CATEGORY;
CREATE TABLE SB_ITEM_CATEGORY
(
  item_category_id Binary(16) NOT NULL,
  item_category_code Int NOT NULL AUTO_INCREMENT,
